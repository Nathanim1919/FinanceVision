          ...
          <Button className="btns">
            {!user ? (
              ...
              <div className="dashboardLink">
                <NavLink className="gotoDashboard" to="/dashboard">
                  <MdDashboard />
                  Dashboard
                </NavLink>
              </div>
      ...
      <div className="hero">
        <div>
          ...
          <div className="hero-text">
            ...
            <h1>
              Know where your <span>money</span> goes.
            </h1>
            <p>
              Track income, expenses, and transactions effortlessly. Gain
              insights and achieve financial goals.
            </p>
