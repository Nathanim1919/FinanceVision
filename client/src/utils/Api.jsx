...
export const BASE_URL='https://www.nathanimt.me/';
// export const BASE_URL = 'https://financevision-2.onrender.com';

export const VERCEL_DOMAIN = 'https://finance-vision.vercel.app';
export const SOCKET_URL = 'https://finance-vision.vercel.app';
export const GOOGLE_API_KEY="AIzaSyC_Q1Dv_cPfOdZ6IQqmpJk13DbnZ1LvxAc";
